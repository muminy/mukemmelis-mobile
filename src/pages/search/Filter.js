    ...
    <Layout disableHeader title="isbul.com">
      <Container style={style.container}>
        <PageTitle
          disableTumunugor
          header="Bölge"
          info="İle göre arama yapın"
        />
      </Container>
      <TouchContainer
        onPress={() =>
          nav.navigate(PagesRouteName.bottom.search.filter.sehirler)
        }
        alignItems="center"
        flex="row"
        style={style.form}>
      ...
      <Container style={style.container}>
        <PageTitle
          disableTumunugor
          header="Çalışma tipi"
          info="Çalışma tipine göre arama yapın"
        />
      </Container>
      <TouchContainer
        onPress={() => nav.navigate(PagesRouteName.bottom.search.filter.tip)}
        alignItems="center"
        flex="row"
        style={style.form}>
      ...
      <Container style={style.container}>
        <PageTitle
          disableTumunugor
          header="Tecrübe"
          info="İş tecrübesine göre ara"
        />
      </Container>
      <TouchContainer
        onPress={() => nav.navigate(PagesRouteName.bottom.search.filter.seviye)}
        alignItems="center"
        flex="row"
        style={style.form}>
